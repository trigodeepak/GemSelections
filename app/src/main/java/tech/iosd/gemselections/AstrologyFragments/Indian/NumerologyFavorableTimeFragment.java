...
//                ,Constants.TIMEZONE);
            ...
            call.enqueue(new Callback<NumeroFavTimeResponse>() {
                @Override
                public void onResponse(Call<NumeroFavTimeResponse> call, Response<NumeroFavTimeResponse> response) {
...
//                            responseString = responseString.concat(response.body().getReport().get(i));
                ...
                @Override
                public void onFailure(Call<NumeroFavTimeResponse> call, Throwable t) {
