...
public class NumerologyReportFragment extends Fragment {
    Retrofit retrofit;
...
//                ,Constants.TIMEZONE);
            ...
            Call<NumerologyReportResponse> call = astrologyApiInterface
                    .getNumerologyReport(AstrologyApiInterface.HEADER_TOKEN, numerologyReportRequest);

            call.enqueue(new Callback<NumerologyReportResponse>() {
                @Override
                public void onResponse(Call<NumerologyReportResponse> call, Response<NumerologyReportResponse> response) {
...
//                            responseString = responseString.concat(response.body().getReport().get(i));
                ...
                @Override
                public void onFailure(Call<NumerologyReportResponse> call, Throwable t) {
