...
public class CompositeHoroscopeFragment extends Fragment {
...
//                ,Constants.TIMEZONE);
            ...
            Call<CompositeHoroscopeResponse> call = astrologyApiInterface
                    .getCompositeHoroscope(AstrologyApiInterface.HEADER_TOKEN, westernAstrologyComplexRequest);
                ...
                public void onResponse(Call<CompositeHoroscopeResponse> call, Response<CompositeHoroscopeResponse> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (response.body().getComposite().getAspects() != null) {
                            ...
                            aspectArrayList.addAll(response.body().getComposite().getAspects());
