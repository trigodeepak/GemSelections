...
public class MajorCharDashaFragment  extends Fragment {
    Retrofit retrofit;
...
//        bundle = new Bundle();
        if (bundle != null) {
            ...
            Call<List<MajorCharDashaResponse>> call = astrologyApiInterface
                    .getMajorCharDasha(AstrologyApiInterface.HEADER_TOKEN, westernAstrologySimpleRequest);

            call.enqueue(new Callback<List<MajorCharDashaResponse>>() {
                @Override
                public void onResponse(Call<List<MajorCharDashaResponse>> call, Response<List<MajorCharDashaResponse>> response) {
...
//                            responseString = responseString.concat(response.body().getReport().get(i));
                ...
                @Override
                public void onFailure(Call<List<MajorCharDashaResponse>> call, Throwable t) {
