...
public class NumerologyPlaceVastuFragment  extends Fragment {
    Retrofit retrofit;
...
//                ,Constants.TIMEZONE);
            ...
            Call<NumeroPlaceVastuResponse> call = astrologyApiInterface
                    .getNumeroPlaceVastu(AstrologyApiInterface.HEADER_TOKEN, numerologyReportRequest);

            call.enqueue(new Callback<NumeroPlaceVastuResponse>() {
                @Override
                public void onResponse(Call<NumeroPlaceVastuResponse> call, Response<NumeroPlaceVastuResponse> response) {
...
//                            responseString = responseString.concat(response.body().getReport().get(i));
                ...
                @Override
                public void onFailure(Call<NumeroPlaceVastuResponse> call, Throwable t) {
