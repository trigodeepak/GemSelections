...
public class PersonalityReportFragment extends Fragment {
    Retrofit retrofit;
...
//                ,Constants.TIMEZONE);
            ...
            Call<PersonalityReportResponse> call = astrologyApiInterface
                    .getPersonalityReport(AstrologyApiInterface.HEADER_TOKEN, westernAstrologySimpleRequest);

            call.enqueue(new Callback<PersonalityReportResponse>() {
                @Override
                public void onResponse(Call<PersonalityReportResponse> call, Response<PersonalityReportResponse> response) {
...
//                            responseString = responseString.concat(response.body().getReport().get(i));
                ...
                @Override
                public void onFailure(Call<PersonalityReportResponse> call, Throwable t) {
