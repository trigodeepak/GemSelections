...
public class PersonalizedPlanetPredictionFragment extends Fragment {
    Retrofit retrofit;
...
//                ,Constants.TIMEZONE);
            ...
            call.enqueue(new Callback<PersonalizedPlanetPredictionResponse>() {
                @Override
                public void onResponse(Call<PersonalizedPlanetPredictionResponse> call, Response<PersonalizedPlanetPredictionResponse> response) {
...
//                            responseString = responseString.concat(response.body().getReport().get(i));
                            responseTextView.append("\n" + response.body().getPersonalisedReport().get(i));
                        }
...
//                        responseTextView.append("\n Spiritual Lesson : "+ response.body().getSpiritualLesson());
                ...
                @Override
                public void onFailure(Call<PersonalizedPlanetPredictionResponse> call, Throwable t) {
