...
public class ForgetPassActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(tech.iosd.gemselections.R.layout.activity_forget_pass);

        mAuth = FirebaseAuth.getInstance();
        _email = (EditText)findViewById(tech.iosd.gemselections.R.id._frgtEmail);
        _submit = (Button)findViewById(tech.iosd.gemselections.R.id._forgetButton);
