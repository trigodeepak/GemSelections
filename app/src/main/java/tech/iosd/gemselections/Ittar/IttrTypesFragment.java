...
public class IttrTypesFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_ittr_types, container, false);

        chandan = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittar_chandan);  chandan.setOnClickListener(this);
        motia = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_motia);   motia.setOnClickListener(this);
        gulab = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_gulab);   gulab.setOnClickListener(this);
        chameli = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_chameli);   chameli.setOnClickListener(this);
        musk = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_musk);   musk.setOnClickListener(this);
        kewara = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_kewara);   kewara.setOnClickListener(this);
        khuskhus = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_khuskhus);   khuskhus.setOnClickListener(this);
        rat = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_rat_ke_rani);   rat.setOnClickListener(this);
        shama = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittr_shama);   shama.setOnClickListener(this);
        banner = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.ittar_banner);

        price_list = (Button)view.findViewById(tech.iosd.gemselections.R.id.ittar_price_list);
    ...
    public void onClick(View v) {
        if(v==chandan){
            show_dialog("CHANDAN ATTAR", tech.iosd.gemselections.R.string.ittr_1);
        }
        if(v==motia){
            show_dialog("MOTIA ATTAR", tech.iosd.gemselections.R.string.ittr_2);
        }
        if(v==gulab){
            show_dialog("GULAB ATTAR", tech.iosd.gemselections.R.string.ittr_3);
        }
        if(v==chameli){
            show_dialog("CHAMELI ATTAR", tech.iosd.gemselections.R.string.ittr_4);
        }
        if(v==musk){
            show_dialog("MUSK ATTAR", tech.iosd.gemselections.R.string.ittr_5);
        }
        if(v==kewara){
            show_dialog("KEWARA ATTAR", tech.iosd.gemselections.R.string.ittr_6);
        }
        if(v==khuskhus){
            show_dialog("KHUSKHUS ATTAR", tech.iosd.gemselections.R.string.ittr_7);
        }
        if(v==rat){
            show_dialog("RAT KE RANI ATTAR", tech.iosd.gemselections.R.string.ittr_8);
        }
        if(v==shama){
            show_dialog("SHAMA ATTAR", tech.iosd.gemselections.R.string.ittr_9);
        }
    }
