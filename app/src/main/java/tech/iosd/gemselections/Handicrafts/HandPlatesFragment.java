...
public class HandPlatesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_hand_plates, container, false);
        _1 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate1);
        _2 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate2);
        _3 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate3);
        _4 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate4);
        _5 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate5);
        _6 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate6);
        _7 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate7);
        _8 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate8);
        _9 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate9);
        _10 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate10);
        _11 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate11);
        _12 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handplate12);
        return view;
    }
