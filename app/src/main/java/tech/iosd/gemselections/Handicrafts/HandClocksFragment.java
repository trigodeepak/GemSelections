...
public class HandClocksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_hand_clocks, container, false);
        _1 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handclock1);
        _2 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handclock2);
        _3 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handclock3);
        _4 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handclock4);
        _5 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.handclock5);
        return view;
    }
