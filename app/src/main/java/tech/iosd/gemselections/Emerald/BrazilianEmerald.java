...
public class BrazilianEmerald extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_brazilian_emerald, container, false);
        banner = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.brazilian_emerald_banner);
        try{
        ...
        spinner = (Spinner)view.findViewById(tech.iosd.gemselections.R.id.emerald_brazilian_spinner);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        break;
                    case 1:
                        show_dialog("A Grade", tech.iosd.gemselections.R.string.emerald_cabo1);
                        break;
                    case 2:
                        show_dialog("B Grade", tech.iosd.gemselections.R.string.emerald_cabo2);
                        break;
                    case 3:
                        show_dialog("C Grade", tech.iosd.gemselections.R.string.emerald_cabo3);
                        break;
                    case 4:
                        show_dialog("D Grade", tech.iosd.gemselections.R.string.emerald_cabo4);
                        break;
                }
            }
