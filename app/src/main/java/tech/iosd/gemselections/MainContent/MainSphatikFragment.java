...
public class MainSphatikFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_sphatik, container, false);
        _1 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik1);
        _2 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik2);
        _3 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik3);
        _4 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik4);
        _5 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik5);
        _6 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik6);
        _7 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik7);
        _8 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik8);
        _9 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik9);
        _10 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik10);
        _11 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik11);
        _12 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik12);
        _13 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.sphtik13);
        return view;
    }
