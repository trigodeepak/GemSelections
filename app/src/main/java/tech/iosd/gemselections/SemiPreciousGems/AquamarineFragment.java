...
public class AquamarineFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.aquamarine, container, false);
        ...
        transaction.add(R.id.aquamarine_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.aquamarine_img);
        try {
