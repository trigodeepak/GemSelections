...
public class Opal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.opal, container, false);
        ...
        transaction.add(tech.iosd.gemselections.R.id.opal_video, youTubePlayerFragment).commit();


        img1 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.opal1);
        img2 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.opal2);
        img3 = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.opal3);
        InputStream is;
        try {
