...
public class AmethystFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.amethyst, container, false);
        ...
        transaction.add(tech.iosd.gemselections.R.id.amethyst_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.amethyst_img);
        try {
