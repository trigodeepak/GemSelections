...
public class JewelleryAlpha extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private BannerArrayAdapter adapater;
    private ArrayList<Banner> typesList = new ArrayList<Banner>();
    ...
    protected void onCreate(Bundle bundle) {
        ...
        listView = (ListView) findViewById(R.id.list_jwellery);
        //listView.setHasFixedSize(true);
        //listView.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.HORIZONTAL));

        //listView.setLayoutManager(new LinearLayoutManager(JewelleryAlpha.this));
       ...
       // setData();
        ...
        adapater = new BannerArrayAdapter(JewelleryAlpha.this, typesList );
