...
public class MainVisitUsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_visit_us, container, false);
        _dir = (Button)view.findViewById(tech.iosd.gemselections.R.id.map_dir);
        ...
        ScrollView scrollView = (ScrollView)view.findViewById(R.id.scroll_visit);
        scrollView.setBackground(getResources().getDrawable(R.drawable.back));

        _locate = (Button)view.findViewById(tech.iosd.gemselections.R.id.map_visit);
