...
public class GayaGomed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_gaya_gomed, container, false);
        img = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.img_gaya_gomed);
        try{
            InputStream is = getActivity().getAssets().open("images/precious-gems/gaya-gomed.jpg");
            img.setImageBitmap(BitmapFactory.decodeStream(is));
        }catch (IOException e){
            e.printStackTrace();
        }
        btn = (Button)view.findViewById(tech.iosd.gemselections.R.id.btn_gaya_gomed_price);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                show_dialog("Gaya Gomed", tech.iosd.gemselections.R.string.gaya_gomed_price);
            }
        });

        btn1 = (Button)view.findViewById(tech.iosd.gemselections.R.id.btn_gaya_gomed_certi);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                display_image("images/govt-certified-gaya-gomed.jpg", "IIGDT Certificate");
            }
        });
        return view;
    }
