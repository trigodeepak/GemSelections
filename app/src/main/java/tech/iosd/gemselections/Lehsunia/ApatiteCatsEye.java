...
public class ApatiteCatsEye extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(tech.iosd.gemselections.R.layout.frag_apatite_catseye, container, false);
        img = (ImageView)view.findViewById(tech.iosd.gemselections.R.id.img_apatite_catseye);
        try{
