...
public class WhiteTopaz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.whitetopaz, container, false);
        ...
        transaction.add(R.id.whitetopaz_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.whitetopaz_img);
        try {
