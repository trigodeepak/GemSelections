...
public class HandGiftsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_hand_gifts, container, false);
        _1 = (ImageView)view.findViewById(R.id.handgift1);
        _2 = (ImageView)view.findViewById(R.id.handgift2);
        _3 = (ImageView)view.findViewById(R.id.handgift3);
        _4 = (ImageView)view.findViewById(R.id.handgift4);
        _5 = (ImageView)view.findViewById(R.id.handgift5);
        _6 = (ImageView)view.findViewById(R.id.handgift6);
        _7 = (ImageView)view.findViewById(R.id.handgift7);
        _8 = (ImageView)view.findViewById(R.id.handgift8);
        _9 = (ImageView)view.findViewById(R.id.handgift9);
        _10 = (ImageView)view.findViewById(R.id.handgift10);
        _11 = (ImageView)view.findViewById(R.id.handgift11);
        return view;
    }
