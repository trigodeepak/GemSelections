...
public class GreenOnyx extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.greenonyx, container, false);
        ...
        transaction.add(R.id.green_onyx_video, youTubePlayerFragment).commit();


        img = (ImageView)view.findViewById(R.id.greenonyx_img);
        try {
