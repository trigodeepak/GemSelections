...
public class Labradorite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.labradorite, container, false);
        ...
        transaction.add(R.id.labradorite_video, youTubePlayerFragment).commit();


        img = (ImageView)view.findViewById(R.id.labradorite_img);
        try {
