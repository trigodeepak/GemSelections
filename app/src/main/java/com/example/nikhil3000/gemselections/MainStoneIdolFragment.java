...
public class MainStoneIdolFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_stone_idol, container, false);
        _1 = (ImageView)view.findViewById(R.id.stoneidol1);
        _2 = (ImageView)view.findViewById(R.id.stoneidol2);
        _3 = (ImageView)view.findViewById(R.id.stoneidol3);
        _4 = (ImageView)view.findViewById(R.id.stoneidol4);
        _5 = (ImageView)view.findViewById(R.id.stoneidol5);
        _6 = (ImageView)view.findViewById(R.id.stoneidol6);
        _7 = (ImageView)view.findViewById(R.id.stoneidol7);
        _8 = (ImageView)view.findViewById(R.id.stoneidol8);
        _9 = (ImageView)view.findViewById(R.id.stoneidol9);
        _10 = (ImageView)view.findViewById(R.id.stoneidol10);
        _11 = (ImageView)view.findViewById(R.id.stoneidol11);
        _12 = (ImageView)view.findViewById(R.id.stoneidol12);
        _13 = (ImageView)view.findViewById(R.id.stoneidol13);
        _14 = (ImageView)view.findViewById(R.id.stoneidol14);
        _15 = (ImageView)view.findViewById(R.id.stoneidol15);
        return view;
    }
