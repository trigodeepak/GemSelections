...
public class BeadsPreciousFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.frag_beads_precious, container, false);

        sapphire = (ImageView) view.findViewById(R.id.beads_neelam);
        panna = (ImageView) view.findViewById(R.id.beads_panna);
        ruby = (ImageView) view.findViewById(R.id.beads_ruby);
        iolite = (ImageView) view.findViewById(R.id.beads_iolite);
        multi = (ImageView) view.findViewById(R.id.beads_multi_tourmaline);
        multi_color = (ImageView) view.findViewById(R.id.beads_multi);
        peridot = (ImageView) view.findViewById(R.id.beads_peridot);
        green = (ImageView) view.findViewById(R.id.beads_green_tourmaline);
        green_garnet = (ImageView) view.findViewById(R.id.beads_green_garnet);
        moti = (ImageView) view.findViewById(R.id.beads_pearl);
        tanzanite = (ImageView) view.findViewById(R.id.beads_tanzanite);
        red = (ImageView) view.findViewById(R.id.beads_red_tourmaline);
