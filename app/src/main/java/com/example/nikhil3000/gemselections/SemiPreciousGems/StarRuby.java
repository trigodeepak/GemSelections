...
public class StarRuby extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.starruby, container, false);
        ...
        transaction.add(R.id.starruby_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.starruby_img);
        try {
