...
public class GayaGomed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_gaya_gomed, container, false);
        img = (ImageView)view.findViewById(R.id.img_gaya_gomed);
        try{
        ...
        btn = (Button)view.findViewById(R.id.btn_gaya_gomed_price);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                show_dialog("Gaya Gomed", R.string.gaya_gomed_price);
            }
        });

        btn1 = (Button)view.findViewById(R.id.btn_gaya_gomed_certi);
