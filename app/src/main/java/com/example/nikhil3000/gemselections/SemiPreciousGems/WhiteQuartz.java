...
public class WhiteQuartz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.whitequartz, container, false);
        ...
        transaction.add(R.id.quartz_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.whitequartz_img);
        try {
