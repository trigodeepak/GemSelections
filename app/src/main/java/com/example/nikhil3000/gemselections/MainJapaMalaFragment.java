...
public class MainJapaMalaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_japa_mala, container, false);

        _1 = (ImageView)view.findViewById(R.id.japamala1);
        _2 = (ImageView)view.findViewById(R.id.japamala2);
        _3 = (ImageView)view.findViewById(R.id.japamala3);
        _4 = (ImageView)view.findViewById(R.id.japamala4);
        _5 = (ImageView)view.findViewById(R.id.japamala5);
        _6 = (ImageView)view.findViewById(R.id.japamala6);
        _7 = (ImageView)view.findViewById(R.id.japamala7);
        _8 = (ImageView)view.findViewById(R.id.japamala8);
        _9 = (ImageView)view.findViewById(R.id.japamala9);
        _10 = (ImageView)view.findViewById(R.id.japamala10);
        _11 = (ImageView)view.findViewById(R.id.japamala11);
        _12 = (ImageView)view.findViewById(R.id.japamala12);
        _13 = (ImageView)view.findViewById(R.id.japamala13);
        _14 = (ImageView)view.findViewById(R.id.japamala14);
        _15 = (ImageView)view.findViewById(R.id.japamala15);
        _16 = (ImageView)view.findViewById(R.id.japamala16);
        _17 = (ImageView)view.findViewById(R.id.japamala17);
        return view;
    }
