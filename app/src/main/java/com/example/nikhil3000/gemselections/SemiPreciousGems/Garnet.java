...
public class Garnet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.garnet, container, false);
        ...
        transaction.add(R.id.garnet_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.garnet_img);
        try {
            InputStream is = getActivity().getAssets().open("images/semi-precious-gems/Garnet.jpg");
