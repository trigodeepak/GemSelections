...
public class TigersEye extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.tigerseye, container, false);
        ...
        transaction.add(R.id.tigerseye_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.tigerseye_img);
        try {
