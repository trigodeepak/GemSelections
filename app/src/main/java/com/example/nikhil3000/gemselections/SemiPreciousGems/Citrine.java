...
public class Citrine extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.citrine, container, false);
        ...
        transaction.add(R.id.citrine_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.citrine_img);
        try {
