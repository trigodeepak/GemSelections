...
public class GreenFluorite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.greenfluorite, container, false);
        ...
        transaction.add(R.id.green_fluorite_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.greenfluorite_img);
        try {
