...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _already = (TextView)findViewById(R.id._signupregistered);
        _already.setOnClickListener(this);
        _name = (EditText)findViewById(R.id._signupname);
        _email = (EditText)findViewById(R.id._signupemail);
        _contact = (EditText)findViewById(R.id._signupphone);
        _pass = (EditText)findViewById(R.id._signuppass);
    }
