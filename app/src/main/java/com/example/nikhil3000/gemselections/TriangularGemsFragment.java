...
public class TriangularGemsFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_triangular_gems, container, false);
        _1 = (ImageView)view.findViewById(R.id.triangular1);     _1.setOnClickListener(this);
        _2 = (ImageView)view.findViewById(R.id.triangular2);     _2.setOnClickListener(this);
        _3 = (ImageView)view.findViewById(R.id.triangular3);     _3.setOnClickListener(this);
        _4 = (ImageView)view.findViewById(R.id.triangular4);     _4.setOnClickListener(this);
        _5 = (ImageView)view.findViewById(R.id.triangular5);     _5.setOnClickListener(this);
        _6 = (ImageView)view.findViewById(R.id.triangular6);     _6.setOnClickListener(this);
        _7 = (ImageView)view.findViewById(R.id.triangular7);     _7.setOnClickListener(this);
        _8 = (ImageView)view.findViewById(R.id.triangular8);     _8.setOnClickListener(this);
        return view;
    }
    ...
    public void onClick(View v) {
        if(v==_1){
            show_dialog("Golden Topaz(Triangular)", R.string.triangular3);
        }
        if(v==_2){
            show_dialog("Lemon Topaz(Triangular)", R.string.triangular4);
        }
        if(v==_3){
            show_dialog("Green Amethyst(Triangular)", R.string.triangular5);
        }
        if(v==_4){
            show_dialog("Rose Quartz(Triangular)", R.string.triangular6);
        }
        if(v==_5){
            show_dialog("Green Fluorite(Triangular)", R.string.triangular7);
        }
        if(v==_6){
            show_dialog("Smoky Topaz(Triangular)", R.string.triangular8);
        }
        if(v==_7){
            show_dialog("Green Onyx(Triangular)", R.string.triangular9);
        }
        if(v==_8){
            show_dialog("White Quartz(Triangular)", R.string.triangular10);
        }
    }
}
