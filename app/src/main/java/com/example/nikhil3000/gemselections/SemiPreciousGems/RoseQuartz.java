...
public class RoseQuartz extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.rosequartz, container, false);
        ...
        transaction.add(R.id.rose_quartz_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.rosequartz_img);
        try {
