...
public class SwatEmerald extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_swat_emerald, container, false);
        banner = (ImageView)view.findViewById(R.id.swat_emerald_banner);
        try{
            InputStream is = getActivity().getAssets().open("images/precious-gems/Emerald/swat-emerald.jpg");
            banner.setImageBitmap(BitmapFactory.decodeStream(is));
        }catch (IOException e){
            e.printStackTrace();
        }

        spinner = (Spinner)view.findViewById(R.id.emerald_swat_spinner);
