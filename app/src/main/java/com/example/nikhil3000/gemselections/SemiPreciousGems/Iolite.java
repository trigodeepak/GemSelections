...
public class Iolite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.iolite, container, false);
        ...
        transaction.add(R.id.iolite_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.iolite_img);
        try {
