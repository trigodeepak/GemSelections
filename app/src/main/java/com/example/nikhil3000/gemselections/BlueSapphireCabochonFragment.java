...
public class BlueSapphireCabochonFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_cabochon_bluesapphire, container, false);
        ...
        transaction.add(R.id.bluesapphire_cabochon_video, youTubePlayerFragment).commit();

        _1 = (ImageView)view.findViewById(R.id.bluesapphire_cabochonimg);
        try{
