...
public class GreenAmethyst extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.greenamethyst, container, false);
        ...
        transaction.add(R.id.green_amethyst_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.greenamethyst_img);
        try {
