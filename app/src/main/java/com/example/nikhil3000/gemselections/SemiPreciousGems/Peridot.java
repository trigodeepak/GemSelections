...
public class Peridot extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.peridot, container, false);
        ...
        transaction.add(R.id.peridot_video, youTubePlayerFragment).commit();


        img = (ImageView)view.findViewById(R.id.peridot_img);
        try {
