...
public class Malachite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.malachite, container, false);
        ...
        transaction.add(R.id.malachite_video, youTubePlayerFragment).commit();

        img = (ImageView)view.findViewById(R.id.malachite_img);
        try {
            InputStream is = getActivity().getAssets().open("images/semi-precious-gems/Malachite.jpg");
